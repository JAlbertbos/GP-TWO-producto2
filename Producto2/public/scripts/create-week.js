...
//   // Función para guardar semana en el servidor
//   async function saveWeekToServer(name, week, priority, year, description, borderColor) {
//     try {
//       const createdWeek = await createWeek(name, week, priority, year, description, borderColor);

//       // Retorna el ID generado por el servidor
//       return createdWeek._id;
//     } catch (error) {
//       // Muestra el error en el frontend, por ejemplo, en un elemento de alerta
...
import { createWeek } from './graphql-queries.js';
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function saveWeekToServer(name, week, priority, year, description, borderColor) {
    try {
      ...
      if (createdWeek !== null && createdWeek.hasOwnProperty('_id')) {
        // Retorna el ID generado por el servidor
        console.log('Created week response:', createdWeek);
        return createdWeek._id;
      } else {
  ...
  async function createCard(name, week, priority, year, description, color) {
    ...
    const id = await saveWeekToServer(name, week, priority, year, description, selectedColor);
